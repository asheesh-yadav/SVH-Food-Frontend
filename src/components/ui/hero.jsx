...
const Hero = React.forwardRef((
  ...
  return (
    <section
      ref={ref}
      className={cn(
        "relative z-0 flex min-h-[100vh] w-full flex-col items-center justify-center overflow-hidden  bg-[#171718]", // background is [#171718]
        className
      )}
      {...props}
    >
      {gradient && (
        <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
          ...
          <motion.div
            initial={{ width: "15rem" }}
            whileInView={{ width: isMdUp ? "30rem" : "10rem" }}
            transition={{ ease: "easeInOut", delay: 0.3, duration: 0.8 }}
            viewport={{ once: true }}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, width: isMdUp ? "30rem" : "10rem" }}
            transition={{
              delay: 0.3,
              duration: 0.8,
              ease: "easeInOut",
          ...
          >
            <div className="absolute w-[100%] left-0 bg-[#171718] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
            <div className="absolute w-40 h-[100%] left-0 bg-[#171718] bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
          </motion.div>
          ...
          >
            <div className="absolute w-40 h-[100%] right-0 bg-[#171718] bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
            <div className="absolute w-[100%] right-0 bg-[#171718] h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
          </motion.div>
        </div>
      )}
      ...
      >
        <div className="flex flex-col items-center text-center space-y-4 text-white">
          ...
          {actions && actions.length > 0 && (
            <div className={cn("flex text-[#171718] font-semibold gap-4", actionsClassName)}>
