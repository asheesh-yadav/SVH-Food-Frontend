...
export function Header1() {
	...
	return (
		<header
			className={cn('fixed bg-[#ffffff6e] top-0 z-50 w-full border-b border-transparent', {
			...
			<nav
				...
				<div className="flex items-center gap-5">
					...
					<NavigationMenu className="hidden md:flex">
						<NavigationMenuList>
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent text-black">Product</NavigationMenuTrigger>
							...
							<NavigationMenuItem>
								...
								<NavigationMenuContent className="bg-background p-1 pr-1.5 pb-1.5">
									<div className="grid w-lg grid-cols-2 gap-2">
										<ul className="bg-popover text-black space-y-2 rounded-md border p-2 shadow">
					...
					<SignedIn>
						...
						>
							<UserButton.MenuItems>
								<UserButton.Action
									label="Dashboard"
									labelIcon={<span><LayoutDashboardIcon className="size-4" /></span>}
